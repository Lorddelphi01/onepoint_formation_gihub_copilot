...
| `11-obsidian-rag/` | Chapitre bonus (optionnel, nécessite Obsidian) : connecter Copilot CLI à un vault Obsidian via deux serveurs MCP (recherche sémantique + accès au vault) pour construire un pipeline RAG local sur ses propres notes |
