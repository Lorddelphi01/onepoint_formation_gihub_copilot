...
| `10-n8n-workflows/` | Chapitre bonus (optionnel, nécessite Docker) : connecter Copilot CLI au serveur MCP de n8n et utiliser les skills n8n officielles pour construire un workflow visuel |
