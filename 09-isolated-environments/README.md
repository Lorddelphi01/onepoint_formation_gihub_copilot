...
> 📋 **Référence rapide** : consultez [Docker Sandboxes pour Copilot CLI](https://docs.github.com/en/copilot/reference/cli-command-reference) et la [documentation officielle Docker Sandboxes / Copilot](https://docs.docker.com/ai/sandboxes/agents/copilot/) pour la liste complète des options.
...
| 09 | Exécuter Copilot CLI dans des environnements isolés (dev container, sandbox Docker) |

Vous êtes maintenant équipé pour utiliser GitHub Copilot CLI comme un véritable multiplicateur de force — y compris en pleine autonomie, dans un environnement qui protège le reste de votre machine.
...
- [Docker Sandboxes](https://docs.docker.com/ai/sandboxes/agents/copilot/)
...
**Excellent travail ! Maintenant, allez construire quelque chose d'extraordinaire — en toute sécurité.**

**[← Retour au Chapitre 08](../08-putting-it-together/README.md)** | **[Retour à l'accueil du cours →](../README.md)**
