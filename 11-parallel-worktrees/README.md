...
![Chapitre 11 : Sessions parallèles avec les worktrees Git](assets/chapter-header.png)
...
Au [Chapitre 08](../08-putting-it-together/README.md), un encadré évoquait en une ligne `/worktree new`, disponible depuis Copilot CLI v1.0.79. Au [Chapitre 10](../10-isolated-environments/README.md), vous avez appris à isoler Copilot CLI pour qu'il travaille sans surveillance humaine. Ce chapitre bonus développe un troisième axe, complémentaire : l'isolation au service de la **parallélisation**. Vous allez apprendre à faire tourner plusieurs sessions Copilot CLI en même temps, sur le même clone de dépôt, chacune sur sa propre tâche, grâce aux **worktrees Git**.
