...
Trois templates de prompts prêts à remplir, utilisés par le [Chapitre 11 : Rédiger des instructions IA efficaces et réutilisables](../../11-prompt-engineering/README.md). Chacun cible `samples/book-app-project/`, mais la structure (objectif / contraintes / format de sortie attendu) est pensée pour être copiée et adaptée à n'importe quel projet.
