#!/usr/bin/env bash
# Installe GitHub Copilot CLI et vérifie l'installation sur macOS.
...
echo "🚀 Installation de GitHub Copilot CLI (macOS)..."
...
if command -v copilot &> /dev/null; then
    ...
    echo "⚠️  Homebrew introuvable, tentative via le script officiel..."
