...
| 11 | 🪙 [mcp2cli et le coût en tokens](./11-mcp2cli/README.md) *(bonus, complète le Chapitre 07)* | Interroger le serveur Context7 MCP directement depuis le terminal, sans passer par Copilot |
