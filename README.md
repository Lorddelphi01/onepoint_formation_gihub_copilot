...
| 11 | 🧠 [Rédiger des instructions IA efficaces et réutilisables](./11-prompt-engineering/README.md) *(bonus)* | Des templates de prompts réutilisables et le principe d'une CLI générée depuis un serveur MCP |
